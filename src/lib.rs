...
//! ```
//!
//! ## Specifying flag types
//!
//! There are three types of arguments that can be supplied: short,
//! long and positional.  structopt defaults to creating long
//! arguments, generated by converting `snake_case` field names to
//! `kebab-case`.  If you want another option you can define any
//! combination of `short` and `long`, or `positional` to create a
//! positional argument.  An example may make things clearer:
//!
//! ```
